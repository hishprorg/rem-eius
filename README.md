...
[![npm](https://img.shields.io/npm/v/@hishprorg/rem-eius.svg)](https://www.npmjs.com/package/@hishprorg/rem-eius)
[![downloads](https://img.shields.io/npm/dt/@hishprorg/rem-eius.svg)](https://www.npmjs.com/package/@hishprorg/rem-eius)
[![types](https://img.shields.io/npm/types/@hishprorg/rem-eius.svg)](https://www.npmjs.com/package/@hishprorg/rem-eius)
[![licence](https://img.shields.io/github/license/mnasyrov/@hishprorg/rem-eius.svg)](https://github.com/hishprorg/rem-eius/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@hishprorg/rem-eius/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@hishprorg/rem-eius?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@hishprorg/rem-eius**][@hishprorg/rem-eius/docs]             | Core elements, state and effect management | [Docs][@hishprorg/rem-eius/docs], [API][@hishprorg/rem-eius/api]             |
| [**@hishprorg/rem-eius-react**][@hishprorg/rem-eius-react/docs] | Tooling for React.js                       | [Docs][@hishprorg/rem-eius-react/docs], [API][@hishprorg/rem-eius-react/api] |
...
```
npm install @hishprorg/rem-eius @hishprorg/rem-eius-react --save
```
...
import { useConst, useObservable, useQuery } from '@hishprorg/rem-eius-react';
...
[@hishprorg/rem-eius/docs]: packages/@hishprorg/rem-eius/README.md
[@hishprorg/rem-eius/api]: packages/@hishprorg/rem-eius/docs/README.md
[@hishprorg/rem-eius-react/docs]: packages/@hishprorg/rem-eius-react/README.md
[@hishprorg/rem-eius-react/api]: packages/@hishprorg/rem-eius-react/docs/README.md
